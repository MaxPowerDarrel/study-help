...
| [deploy-home](./deploy-home.md) | Deprecated | Drafted as a self-host home variant via Duck DNS + Caddy/Let's Encrypt; deprecated 2026-05-08 due to DuckDNS NS-pool unreliability and a `caddy-dns/duckdns` plugin bug; see spec for context |
