...
| [native-reader](./native-reader.md) | Shipped | Native SwiftUI reading surface in the iOS app (default since 2026-06-09), parsing publisher HTML from the unchanged JSON API; web app stays canonical, web view kept as in-app fallback |
